...
namespace GTop {
    [CCode (cheader_filename = "glibtop.h", cname = "glibtop")]
    public struct glibtop {
        public uint flags;
        public uint method;
        ...
        public void get_netload_l (out GTop.glibtop_netload buf, string @interface);
        [CCode (cname = "glibtop_get_netload_s", cheader="glibtop/netload.h")]
        public void get_netload_s (out GTop.glibtop_netload buf, string @interface);
        [CCode (cname = "glibtop_get_parameter_l", cheader="glibtop/netload.h")]
        public ulong get_parameter_l (uint parameter, void* data_ptr, ulong data_size);
        [CCode (cname = "glibtop_get_ppp_l")]
        public void get_ppp_l (out GTop.glibtop_ppp buf, ushort device);
        [CCode (cname = "glibtop_get_ppp_s")]
        public void get_ppp_s (out GTop.glibtop_ppp buf, ushort device);
        ...
        public GTop.glibtop_sysinfo get_sysinfo_s ();
    ...
    [CCode (cheader_filename = "glibtop.h", cname = "glibtop_command")]
    ...
    [CCode (cheader_filename = "glibtop.h", cname = "glibtop_cpu")]
    ...
    [CCode (cheader_filename = "glibtop.h", cname = "glibtop_entry")]
    ...
    [CCode (cheader_filename = "glibtop.h", cname = "glibtop_fsusage")]
    ...
    [CCode (cheader_filename = "glibtop.h", cname = "glibtop_loadavg")]
    ...
    [CCode (cheader_filename = "glibtop.h", cname = "glibtop_map_entry")]
    public struct glibtop_map_entry {
        public uint64 flags;
        public uint64 start;
        public uint64 end;
    ...
    [CCode (cheader_filename = "glibtop.h", cname = "glibtop_mem")]
    ...
    [CCode (cheader_filename = "glibtop.h", cname = "glibtop_mountentry")]
    public struct glibtop_mountentry {
        public uint64 dev;
        [CCode (array_length = false, array_null_terminated = true)]
    ...
    [CCode (cheader_filename = "glibtop.h", cname = "glibtop_mountlist")]
    public struct glibtop_mountlist {
        public uint64 flags;
        public uint64 number;
        public uint64 total;
        public uint64 size;
    }
    [CCode (cheader_filename = "glibtop.h", cname = "glibtop_msg_limits")]
    ...
    [CCode (cheader_filename = "glibtop.h", cname = "glibtop_netlist")]
    public struct glibtop_netlist {
        public uint64 flags;
        public uint32 number;
    }
    [CCode (cheader_filename = "glibtop/netload.h", cname = "glibtop_netload")]
    ...
    [CCode (cheader_filename = "glibtop.h", cname = "glibtop_open_files_entry")]
    ...
    [CCode (cheader_filename = "glibtop.h", cname = "glibtop_ppp")]
    ...
    [CCode (cheader_filename = "glibtop.h", cname = "glibtop_proc_affinity")]
    public struct glibtop_proc_affinity {
        public uint64 flags;
        public uint32 number;
        public bool all;
    }
    [CCode (cheader_filename = "glibtop.h", cname = "glibtop_proc_args")]
    public struct glibtop_proc_args {
        public uint64 flags;
        public uint64 size;
    }
    [CCode (cheader_filename = "glibtop.h", cname = "glibtop_proc_kernel")]
    ...
    [CCode (cheader_filename = "glibtop.h", cname = "glibtop_proc_map")]
    public struct glibtop_proc_map {
        public uint64 flags;
        public uint64 number;
        public uint64 total;
        public uint64 size;
    }
    [CCode (cheader_filename = "glibtop.h", cname = "glibtop_proc_mem")]
    ...
    [CCode (cheader_filename = "glibtop.h", cname = "glibtop_proc_open_files")]
    public struct glibtop_proc_open_files {
        public uint64 flags;
        public uint64 number;
        public uint64 total;
        public uint64 size;
    }
    [CCode (cheader_filename = "glibtop.h", cname = "glibtop_proc_segment")]
    ...
    [CCode (cheader_filename = "glibtop.h", cname = "glibtop_proc_signal")]
    ...
    [CCode (cheader_filename = "glibtop.h", cname = "glibtop_proc_state")]
    ...
    [CCode (cheader_filename = "glibtop.h", cname = "glibtop_proc_time")]
    ...
    [CCode (cheader_filename = "glibtop.h", cname = "glibtop_proc_uid")]
    ...
    [CCode (cheader_filename = "glibtop.h", cname = "glibtop_proc_wd")]
    ...
    [CCode (cheader_filename = "glibtop.h", cname = "glibtop_proclist")]
    ...
    [CCode (cheader_filename = "glibtop.h", cname = "glibtop_response")]
    ...
    [CCode (cheader_filename = "glibtop.h", cname = "glibtop_sem_limits")]
    ...
    [CCode (cheader_filename = "glibtop.h", cname = "glibtop_shm_limits")]
    ...
    [CCode (cheader_filename = "glibtop.h", cname = "glibtop_signame")]
    public struct glibtop_signame {
        public int number;
        public weak string name;
        public weak string label;
    }
    [CCode (cheader_filename = "glibtop.h", cname = "glibtop_swap")]
    ...
    [CCode (cheader_filename = "glibtop.h", cname = "glibtop_sysdeps")]
    ...
    [CCode (cheader_filename = "glibtop.h", cname = "glibtop_sysinfo")]
    ...
    public struct glibtop_union {
        ...
        public GTop.glibtop_proc_map proc_map;
        public GTop.glibtop_mountlist mountlist;
        ...
        public GTop.glibtop_proc_open_files proc_open_files;
        public GTop.glibtop_proc_wd proc_wd;
        public GTop.glibtop_proc_affinity proc_affinity;
    }
    [CCode (cheader_filename = "glibtop.h", cname = "glibtop_uptime")]
    ...
    [CCode (cheader_filename = "glibtop.h")]
    public const int _GLIBTOP_INIT_STATE_INIT;
    [CCode (cheader_filename = "glibtop.h")]
    public const int _GLIBTOP_INIT_STATE_OPEN;
    [CCode (cheader_filename = "glibtop.h")]
    public const int _GLIBTOP_INIT_STATE_SERVER;
    [CCode (cheader_filename = "glibtop.h")]
    public const int _GLIBTOP_INIT_STATE_SYSDEPS;
    [CCode (cheader_filename = "glibtop.h")]
    public const int _GLIBTOP_PARAM_SIZE;
    [CCode (cheader_filename = "glibtop.h")]
    public const int _NFILE;
    ...
    public static uint16 glibtop_get_proc_affinity (out GTop.glibtop_proc_affinity buf, int pid);
    [CCode (cheader_filename = "glibtop.h", cname = "glibtop_get_proc_args")]
    public static string glibtop_get_proc_args (out GTop.glibtop_proc_args buf, int pid, uint max_len);
    [CCode (cheader_filename = "glibtop.h", cname = "glibtop_get_proc_kernel")]
    public static void glibtop_get_proc_kernel (out GTop.glibtop_proc_kernel buf, int pid);
    [CCode (cheader_filename = "glibtop.h", cname = "glibtop_get_proc_mem")]
    public static void glibtop_get_proc_mem (out GTop.glibtop_proc_mem buf, int pid);
    [CCode (cheader_filename = "glibtop.h", cname = "glibtop_get_proc_segment")]
    public static void glibtop_get_proc_segment (out GTop.glibtop_proc_segment buf, int pid);
    [CCode (cheader_filename = "glibtop.h", cname = "glibtop_get_proc_signal")]
    public static void glibtop_get_proc_signal (out GTop.glibtop_proc_signal buf, int pid);
    [CCode (cheader_filename = "glibtop.h", cname = "glibtop_get_proc_state")]
    public static void glibtop_get_proc_state (out GTop.glibtop_proc_state buf, int pid);
    [CCode (cheader_filename = "glibtop.h", cname = "glibtop_get_proc_time")]
    public static void glibtop_get_proc_time (out GTop.glibtop_proc_time buf, int pid);
    [CCode (cheader_filename = "glibtop.h", cname = "glibtop_get_proc_uid")]
    public static void glibtop_get_proc_uid (out GTop.glibtop_proc_uid buf, int pid);
    [CCode (cheader_filename = "glibtop.h", cname = "glibtop_get_proclist")]
    public static int glibtop_get_proclist (out GTop.glibtop_proclist buf, int64 which, int64 arg);
    [CCode (cheader_filename = "glibtop.h", cname = "glibtop_get_sem_limits")]
    public static void glibtop_get_sem_limits (out GTop.glibtop_sem_limits buf);
    [CCode (cheader_filename = "glibtop.h", cname = "glibtop_get_shm_limits")]
    public static void glibtop_get_shm_limits (out GTop.glibtop_shm_limits buf);
    [CCode (cheader_filename = "glibtop.h", cname = "glibtop_get_swap")]
    public static void glibtop_get_swap (out GTop.glibtop_swap buf);
    [CCode (cheader_filename = "glibtop.h", cname = "glibtop_get_sysdeps")]
    public static void glibtop_get_sysdeps (out GTop.glibtop_sysdeps buf);
    [CCode (cheader_filename = "glibtop.h", cname = "glibtop_get_sysinfo")]
    public static GTop.glibtop_sysinfo glibtop_get_sysinfo ();
    [CCode (cheader_filename = "glibtop.h", cname = "glibtop_get_uptime")]
    public static void glibtop_get_uptime (out GTop.glibtop_uptime buf);
