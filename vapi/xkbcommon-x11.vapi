...
namespace Xkb.X11
{
    ...
    [Flags]
    [CCode (cname = "xkb_x11_setup_xkb_extension_flags", cprefix = "XKB_X11_SETUP_XKB_EXTENSION_")]
    ...
    public Xkb.Keymap keymap_new_for_device(Xkb.Context context, int32 device_id, Xkb.KeymapCompileFlags flags = Xkb.KeymapCompileFlags.NO_FLAGS);
    public Xkb.State state_new_for_device(Xkb.Keymap keymap, Xcb.Connection connection, int32 device_id);
}
